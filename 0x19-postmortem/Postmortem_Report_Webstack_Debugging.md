...
<p align="center">
<img src="https://github.com/bankole874/alx-system_engineering-devops/new/master/0x19-postmortem/image.gif" width=100% height=100% />
</p>

### Incident report for [504 error / Site Outage](https://github.com/bankole874/alx-system_engineering-devops/new/master/0x17-web_stack_debugging_3)

#### Summary

At midnight the server access went down resulting in 504 error for anyone trying to access a website. Background on the server being based on a LAMP stack.
